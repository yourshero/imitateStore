    ...
    <div class="choose-address">
        <mt-index-list>
            <mt-index-section v-for='(item,index) in cityData' :key='index' :index="item.name">
                <router-link v-for='item_city in item.cities' :key='item_city.name' :to="{name:'user-address',params:'',query:{'cityName':item_city.name}}">
                <mt-cell :title="item_city.name">
                </mt-cell>
                </router-link>
            </mt-index-section>
        </mt-index-list>
        <!-- <div v-for='item in cityData' :key='item.name'>
            {{item.name}}
            <div :title="item_city.name" v-for='item_city in item.cities' :key='item_city.name'>
                 {{item_city.name}}
            </div>
        </div> -->
    </div>
